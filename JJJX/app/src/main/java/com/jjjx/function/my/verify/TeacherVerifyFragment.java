...
public class TeacherVerifyFragment extends XBaseFragment implements View.OnClickListener {
    ...
    protected void initView(View view) {
        mNameEt = find(R.id.ftv_name);
        mCardEt = find(R.id.ftv_card);
        LinearLayout cityLayout = find(R.id.ftv_city_layout);
        mCityTv = find(R.id.ftv_city);
        mImageGv = find(R.id.ftv_image);
        ...
        mImageGv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (TextUtils.equals(str, VerifyGvAdapter.MDEFAULTURI)) {
                    Matisse.from(TeacherVerifyFragment.this)
